...
5. For this project we have used the BSC Testnet public API key as shown in the figure below. For a complete list of Nodereal Meganode Public API keys, refer to the Nodereal documentation.
...
- For this project we have used the public API key for BSC Testnet. For a complete list of Nodereal Meganode Public API keys, refer to the Nodereal documentation. 
